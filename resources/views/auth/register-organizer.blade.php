<x-auth-layout>
    <form method="POST" action="{{ route('register.organizer.store') }}" enctype="multipart/form-data">
        ...
        <div class="mt-6 p-4 bg-yellow-50 border-l-4 border-yellow-400 text-sm text-yellow-700 rounded">
            Jika pendaftaran Anda disetujui, informasi akun termasuk password akan dikirim melalui email.
        </div>
